 ...
 * @param {string} repoPath
 * @returns {Promise<{comments: object[], adopted: boolean}>}
...
async function readSavedComments(reviewsDir, repoPath) {
  ...
  return { comments: legacy.comments ?? [], adopted: true };
}
