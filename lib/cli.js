...
Installed under both names: reviewer and git-reviewer. The second name also
makes it reachable as a git subcommand: git reviewer

Handing a review to an agent:
  reviewer | claude -p "Apply this review."

  With something reading its output, reviewer writes the finished review there
